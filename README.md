...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-n0l0isi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-n0l0isi.containers.anotherwebservice.com/
...
```
git clone git@github.com:senbonzak/container-n0l0isi.git
cd container-n0l0isi
```
...
```
docker attach container-n0l0isi
```
